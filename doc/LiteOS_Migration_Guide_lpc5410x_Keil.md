...
目前在github上已开源的Huawei LiteOS内核源码已适配好LPC54114、LPC54102、LPC824芯片，本手册将以LPC54102芯片为例，介绍基于Cortex-M4核芯片的移植过程。
...
<table>
	...
	<tr>
	<td>LPCXpresso54102单板</td>
	<td>NXP LPC54102 Board开发板(芯片型号LPC54102J512BD64:M4)</td>
	</tr>
	<tr>
	<td>PC机</td>
	<td>用于编译、加载并调试镜像</td>
...
Keil工具需要开发者自行购买，lpclink2驱动程序可以从NXP官网获取(LPCScrypt)，使用前请先安装。
...
<tr>
	<td></td>
	<td>LPC5410x_Xpresso</td>
	<td>LPC54110开发板systick以及led、uart、key驱动bsp适配代码</td>
</tr>
<tr>
	<td></td>
...
<tr>
    <td></td>
    <td>LPC5410x_Xpresso_KEIL</td>
    <td>LPCXpresso54102开发板的keil工程目录</td>
</tr>
<tr>
	<td>user</td>
	<td></td>
...
### LPCXpresso5410x开发资料获取
- 从keil官网下载PACK包，网址为：http://www.keil.com/dd2/nxp/lpc54102j512bd64/
- 或者直接从该链接下载  https://keilpack.azureedge.net/pack/Keil.LPC54000_DFP.2.4.0.pack
